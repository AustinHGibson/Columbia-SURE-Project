...
axes.set_title("Loss Across Epochs During Training", fontsize = 18)
...
axes.set_xticks(ticks)
axes.xaxis.set_major_formatter(EngFormatter())
axes.set_title("Performance Across Epochs During Training", fontsize = 18)
axes.set_xlabel("Epochs", fontsize = 15)
axes.set_ylabel("Performance", fontsize = 15)
performances_graph.savefig('C:/Users/austi/Downloads/Project/Graphs/Performance.pdf')
